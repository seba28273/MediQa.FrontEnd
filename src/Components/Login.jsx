...
export default function  Login() {
    ...
    const fetchlogin  = async (user, pass) => {
        ...
        await fetch("http://200.115.185.55:4990/LoginAsync?user=" + user + "&password=" +  pass  , { myHeaders })
        ...
        <div className="form-register">
            ...
            <div className="flex justify-content-center">
                <div className="card">
                    ...
                    <Form onSubmit={onSubmit} initialValues={{user: '', password: '', accept: false }} validate={validate} render={({ handleSubmit }) => (
                        <form onSubmit={handleSubmit} className="p-fluid">
                            
                            <Field name="user" render={({ input, meta }) => (
                                <div className="field">
                                    <span className="p-float-label">
                                        <InputText id="user" {...input} 
